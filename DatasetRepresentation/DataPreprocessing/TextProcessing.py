...
from DatasetRepresentation.DataPreprocessing.RNNProcessing import clean_column_name as clean_article_column_name
...
def add_clean_articles_in_df(df, article_column_name):
    clean_articles = list()
