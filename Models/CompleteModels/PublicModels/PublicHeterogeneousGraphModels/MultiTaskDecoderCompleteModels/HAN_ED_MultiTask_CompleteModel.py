...
from Models.NNModels.CombinationModels.EncoderDecoderModels.PublicGNNs.HAN_ED_MultiTask_NNModel import \
    HAN_ED_MultiTask_NNModel


class HAN_ED_MultiTask_CompleteModel(AbstractMultiTaskDecoderCompleteModel):
    def __init__(self, model_hyperparameters):
        super().__init__()
        model = HAN_ED_MultiTask_NNModel(model_hyperparameters["encoder_hyperparameters"],
