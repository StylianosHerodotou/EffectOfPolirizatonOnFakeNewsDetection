...
from Models.NNModels.CombinationModels.EncoderDecoderModels.PrivateGNNs.HEAT_SAG_ED_MLP_Model import \
    HEAT_SAG_ED_MLP_Model


class HEATCompleteModel(AbstractCompletePrivateModel):
    def __init__(self, model_hyperparameters):
        super().__init__()
        model = HEAT_SAG_ED_MLP_Model(model_hyperparameters["encoder_hyperparameters"],
