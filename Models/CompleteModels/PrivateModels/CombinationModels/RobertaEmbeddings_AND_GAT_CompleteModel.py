...
class RobertaEmbeddings_AND_GAT_CompleteModel(AbstractCompletePrivateModel):
    def __init__(self, model_hyperparameters):
        super().__init__()
        model = RobertaEmbeddings_AND_HomogeneousGATModel(model_hyperparameters["encoders_hyperparameters"],
