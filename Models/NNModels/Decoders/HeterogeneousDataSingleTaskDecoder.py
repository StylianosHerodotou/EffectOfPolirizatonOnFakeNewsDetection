from Models.NNModels.Classifiers.HeterogeneousEdgePredictionClassifier import HeterogeneousEdgePredictionClassifier
from Models.NNModels.Classifiers.MLP import MLP
import torch
from torch_geometric.nn import to_hetero


class HeterogeneousDataSingleTaskDecoder(torch.nn.Module):
    def __init__(self, in_channels, pyg_data, classifier_arguments):
        ...
        if classifier_arguments["classifier_type"] == "edge":
            self.classifier = HeterogeneousEdgePredictionClassifier(in_channels=2 * in_channels,
