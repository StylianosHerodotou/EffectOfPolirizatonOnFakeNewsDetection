import torch
from Models.NNModels.Decoders.HomogeneousDataSingleTaskDecoder import HomogeneousDataSingleTaskDecoder


class HomogeneousDataMultiTaskDecoder(torch.nn.Module):
    def __init__(self, in_channels, pyg_data,classifier_per_task_arguments,):
        ...
        for task_name, MLP_arguments in classifier_per_task_arguments.items():
            self.task_decoders[task_name] = HomogeneousDataSingleTaskDecoder(in_channels, pyg_data, MLP_arguments)
